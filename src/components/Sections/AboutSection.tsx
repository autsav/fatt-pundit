  ...
  return (
    <section
      style={{
        ...
        backgroundImage: `linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url(${isCovent ? coventTexture : sohoUtilityBg})`,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Originating from Kolkata, this unique cuisine was invented when the
            Hakka people migrated to India from the Chinese province of Canton,
            bringing with them their culinary treasures. Incorporating
            traditional Chinese cooking techniques with the spices of India to
            create something both new yet familiar, Indo Chinese is now an
          ...
          >
            Playfully named Fatt Pundit it’s a combination of the common Chinese
            surname ‘Fatt’ with the Indian word ‘Pundit’ (a scholar).
          </p>
        </motion.div>
      </div>
      <style>{`

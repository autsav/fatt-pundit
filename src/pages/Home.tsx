...
const Home = () => {
    ...
    return (
        <>
            <SEOHead
                title="Fatt Pundit | Indo-Chinese Restaurant in Soho & Covent Garden London"
                description="Experience bold Indo-Chinese flavors at Fatt Pundit. Two locations in London: Soho and Covent Garden. Book your table or order online today."
                canonical="https://fattpundit.com/"
            />
            <div style={{
                height: '100vh',
                display: 'flex',

...
const ClickCollect = () => {
  ...
  const filteredItems = MENU_ITEMS.filter((item) => {
    ...
    const matchesDiet = selectedDiet
      ? item.dietary.includes(selectedDiet)
      : true;
  ...
  return (
    <>
      ...
      >
        {/* Hero Banner */}
        <div
          className="click-collect-hero"
          style={{
            backgroundColor: "#121212",
            color: "#fff",
            padding: "10rem 2rem 6rem 2rem",
            textAlign: "center",
            backgroundImage: `url(${isCovent ? coventTexture : isSoho ? sohoUtilityBg : menuBgTiger})`,
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              background:
                isSoho || isCovent ? "rgba(0,0,0,0.3)" : "rgba(0,0,0,0.6)",
            }}
          ></div>
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              {displayLocation} CLICK & COLLECT
            </h1>
            <p style={{ fontSize: "1.2rem", opacity: 0.9 }}>
              Order online and pickup from our {displayLocation.toLowerCase()}{" "}
              location.
            </p>
          </div>
        </div>
        ...
        <div
          className="container click-collect-container"
          style={{
            display: "flex",
            gap: "2rem",
            padding: "2rem 1rem",
              ...
              <div style={{ display: "inline-flex", gap: "0.8rem" }}>
                {CATEGORIES.map((cat) => (
                  <button
                    key={cat}
                    onClick={() =>
                      activeCategory !== cat && setActiveCategory(cat)
                    }
                    style={{
                      ...
                      border: "none",
                      backgroundColor:
                        activeCategory === cat ? "var(--color-accent)" : "#fff",
                      color: activeCategory === cat ? "#fff" : "#333",
                      fontSize: "0.9rem",
                      fontWeight: 600,
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "1rem",
                      backgroundColor:
                        cartItems.length === 0 ? "#ccc" : "var(--color-accent)",
                      color: "#fff",
                      border: "none",
                      borderRadius: "8px",
                      fontSize: "1rem",
                    ...
                    onClick={() =>
                      alert(
                        "Checkout functionality coming soon (Stripe integration)!",
                      )
                    }
                  >

...
> = {
  soho: {
    ...
    heroImage: heroFood,
    description:
      "The original Fatt Pundit in the heart of Soho. Experience the buzz of Berwick Street combined with the spicy aromas of Tangra.",
    openingHours: (
      <>
  ...
  "covent-garden": {
    ...
    description:
      "Located in the historic Covent Garden, our second location offers a spacious dining experience with the same bold Indo-Chinese flavours.",
    openingHours: (
      <>
        Monday: Closed
        <br />
        Tue - Thu: 12pm - 2:15pm, 4:45pm - 10:15pm
        <br />

...
export const MENU_DATA_COVENT: Menus = {
    ...
    "A LA CARTE": [
        {
            category: "MOMO'S",
            description: "All meals in Tangra start with these hearty, flavoursome steamed dumplings coming straight from the Steel Steamers, served with a spicy chutney, with influences from Bhutan, Nepal, Tibet & other parts of India.",
            items: [
                { name: "Mix Vegetable Momo", description: "Spinach, mushroom, courgette + tofu", price: "7.00", image: mixVegMomo },
                { name: "Chicken Momo", description: "Soy, garlic, spring onions", price: "7.50", image: momo },
                { name: "Beef Momo", description: "Leeks, red chilli, coriander", price: "8.00", image: momo },
        ...
        },
        {
            category: "VEG",
            items: [
                { name: "Crackling Spinach", description: "Sweet yogurt, date & plum sauce, pomegranate", price: "10.20", image: cracklingSpinach },
                { name: "Crispy Okra Salt 'n' Pepper", description: "Pink salt, chillies, burnt garlic", price: "10.20", image: okraSaltPepper },
                { name: "Hakka Chilly Paneer", description: "Cottage cheese, shallots, soy sauce, white & black pepper", price: "13.25", image: paneerCups },
                { name: "Sticky Sesame Vegetables", description: "Crispy vegetable fritters with sticky ginger", price: "11.20", image: sticky },
                { name: "Bombay Chilli Mock Chicken (Vegan)", description: "Celery, Szechuan chilly, mixed peppers", price: "13.25", image: mockChick },
                { name: "Popcorn Cauliflower", description: "smoked, soya garlic dip", price: "10.20", image: popcornCauliflower }
            ]
        },
        {
            category: "SEAFOOD",
            items: [
                { name: "Malabar Curry (Tiger Prawns)", description: "Grilled in saffron butter with fresh coconut", price: "18.00", image: malabar },
                { name: "Malabar Curry (Monkfish)", description: "Grilled in saffron butter with fresh coconut", price: "15.75", image: monkfish },
                { name: "Bombay Chilly Prawns", description: "Celery, Szechuan chilly & mixed peppers", price: "14.50", image: prawns },
                { name: "Crab 65", description: "Crunchy soft shell crab, spiced mustard paste & curry leaves", price: "14.50", image: crab }
            ]
        },
        {
            category: "MEAT, GAME + POULTRY",
            items: [
                { name: "Szechuan Honey Duck", description: "Crispy duck strips, five spice, pancakes", price: "17.25", image: duck },
                { name: "Lollipop Chicken", description: "Spicy & crispy chicken wings served with Szechuan chutney", price: "10.50", image: lollypop },
                { name: "Kolkata Chilly Chicken", description: "Caramelized onion, slit green chillies, smoked dark soya", price: "13.50", image: manchurian },
                { name: "Shredded Chilly Venison", description: "“Made famous at the Leopold Cafe of Mumbai” smoked sweet chilly, soya caramel mantou bread", price: "15.50", image: venison },
                { name: "Lamb Chops - Black Bean Dust", description: "Stone flower masala rub, charred to perfection", price: "21.00", image: lambchop },
                { name: "Rabbit Wontons", description: "Burnt Garlic, Black Bean", price: "14.20", image: rabbitWontons },
                { name: "Ribeye Dry Red Chilly", description: "Beef strips, Kashmiri red chillies, roasted cashews", price: "19.00", image: ribeye }
            ]
        },
        {
            category: "SIDES",
            items: [
                { name: "Tamarind Glazed Potatoes", description: "Baby potatoes, black salt", price: "6.75", image: sweetPotato },
                { name: "Stir Fry Broccoli", description: "With roasted almonds", price: "6.20", image: broccoli }
            ]
        },
        {
            category: "BREAD, RICE & NOODLES",
            items: [
                { name: "Bing Bread", description: "Buttery, crisp & crunchy", price: "5.20", image: bingBread },
                { name: "Burnt Ginger Rice", description: "", price: "5.65" },
                { name: "Egg Szechuan Fried Rice", description: "", price: "6.65" },
                { name: "Vegetable Hakka Noodles", description: "Bean sprout, cabbage, green onion", price: "10.00", image: vegHakka },
                { name: "Stir Fry Szechuan Noodles", description: "Vegetable, Chicken or Beef", price: "12.20" }
            ]
        },
        {
            category: "DESSERT",
            items: [
                { name: "Snowflake Gelato Sizzling Brownie", description: "Snowflake Gelato’s vanilla with chocolate covered honeycomb", price: "11.50", image: brownie },
                { name: "Vegan Sizzling Brownie", description: "With Madagascan vanilla ice cream", price: "11.50", image: brownie },
                { name: "Lady Kenny", description: "Inspired by Ledikeni Bengali sweet named after Lady Charlotte Canning", price: "7.50", image: ladyKenny }
            ]
        }
    ]
